...
export default function RetailerLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem("userName", "Retailer User")
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-amber-50 to-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Access verified suppliers and manage your purchases</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 bg-gradient-to-r from-amber-500 to-orange-600 text-white rounded-lg hover:shadow-lg hover:shadow-amber-500/30 transition-all font-medium disabled:opacity-50"
          >
            {isLoading ? "Logging in..." : "Login as Retailer"}
          </button>
        </form>
